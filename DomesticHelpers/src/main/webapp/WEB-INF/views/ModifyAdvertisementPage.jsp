...
<html>
<head>
    <title>Modify Advertisement Page</title>
</head>
<body>
...
<div class="container">
    <div class="col-md-8">
        <h4>Modify Advertisement</h4>
        <form action="modifyadvertisementprocess" method="post" autocomplete="off">
            <input type="text" name="id" value="${advertisementDAO.a_id}" hidden />
            <table class="table">
                <tr>
                    <td><b>Title</b></td>
                    <td><input type="text" name="title" class="col-md-12" value="${advertisementDAO.a_title}" required></td>
                </tr>
                <tr>
                    <td><b>Content:</b></td>
                    <td><input type="text" name="content" class="col-md-12" value="${advertisementDAO.a_content}" required></td>
                </tr>
                <tr>
